...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "vinbrucelu.blog.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "vinbrucelu.blog.blog.MsgCreatePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	,
	...
	0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x11, 0x06, 0xea, 0x83, 0x43, 0xae, 0x02, 0x42,
	0x95, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x03, 0xd1, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff,
	0xc3, 0xc2, 0xbf, 0x98, 0x55, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/vinbrucelu.blog.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vinbrucelu.blog.blog.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "vinbrucelu.blog.blog.Msg",
